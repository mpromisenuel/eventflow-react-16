    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-primary py-20 md:py-28">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-display text-4xl md:text-5xl xl:text-6xl font-bold text-primary-foreground">
            About Eventful
          </h1>
          <p className="text-primary-foreground/80 font-body mt-4 max-w-2xl mx-auto text-base leading-relaxed">
          ...
          <div>
            ...
            <div className="flex gap-8 mt-8">
              <div>
                ...
                <p className="text-xs text-muted-foreground font-body mt-1">Events Hosted</p>
              </div>
              <div>
                <span className="font-display text-3xl font-bold text-primary">3.5K</span>
                <p className="text-xs text-muted-foreground font-body mt-1">Happy Attendees</p>
              </div>
              <div>
                <span className="font-display text-3xl font-bold text-primary">98%</span>
                <p className="text-xs text-muted-foreground font-body mt-1">Satisfaction Rate</p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-primary">
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-primary-foreground/70 font-body mb-6 max-w-md mx-auto text-sm">
            Join thousands of organisers who trust Eventful to bring their visions to life.
          </p>
