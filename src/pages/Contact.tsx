          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-body font-medium text-sm">Email</p>
                  <p className="text-muted-foreground font-body text-sm">hello@eventful.com</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-md bg-primary/10 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <p className="font-body font-medium text-sm">Phone</p>
                  <p className="text-muted-foreground font-body text-sm">+1 (555) 123-4567</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-md bg-primary/10 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <p className="font-body font-medium text-sm">Office</p>
                  <p className="text-muted-foreground font-body text-sm">123 Event Street, Suite 100<br />San Francisco, CA 94102</p>
                </div>
              </div>
            </div>

            <div className="mt-10 rounded-xl overflow-hidden h-48 border border-border">
              <img
